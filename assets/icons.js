/* Inline SVG icons (lucide-style) — ported verbatim from inc/helpers.php icon(). */
(function () {
  var PATHS = {
  ...
  /** icon(name, size=18, class='') -> SVG string */
  window.icon = function (name, size, cls) {
    size = size || 18;
    cls = cls || '';
    var p = PATHS[name] || '<circle cx="12" cy="12" r="10"/>';
    return '<svg xmlns="http://www.w3.org/2000/svg" width="' + size + '" height="' + size +
      '" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" ' +
      'stroke-linecap="round" stroke-linejoin="round" class="' + cls + '">' + p + '</svg>';
  };
})();
